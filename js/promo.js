        ...
        if (e.length == 0) {
            ...
            for (var i = 0, proId = proId; i < e.length; ++i) {
                ...
                for (items in itemsInPromo) {
                    console.log('For promo ' + promoSubsId[i].id + ' products are ' + itemsInPromo[items]);
                    // if(itemsInPromo[items] == )
                    for (var ii = 0; ii < getAllProducts.length; ii++) {
                        ...
                        if (prdId == itemsInPromo[items]) {
                            console.log(prdId, itemsInPromo[items])
                            $('.promoItems-' + promoSubsId[i].id).append('<li><div class="chip">' + prodName + '</div></li>')
                        }
                    }
                }
