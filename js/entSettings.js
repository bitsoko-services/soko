...
//Add New Enterprise Service
$(document).on("click", "#saveEntServOne, #saveEntServTwo", function (imgId) {
    ...
    if ($("#entServOneImg").val() == "") {
        ...
        doFetch({
            ...
            value: JSON.stringify(servOneArray),
            prop: "entImageList"
        }).then(function (e) {
            if (e.status == 'ok') {
                M.toast({
