...
$(document).on("change", ".entSettings input", function () {
    ...
    } else if (inputChanged.attr("class") == "serviceImage") {
        console.log("its an image")
        var filesSelected = document.getElementById(inputChanged.attr("id")).files;
