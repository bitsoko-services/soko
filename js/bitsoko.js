...
function refreshBills() {
    doFetch({
        ...
        $.each(bills, function (index, obj) {
            ...
            dailyBill += '<ul class="collapsible" data-collapsible="accordion"><li id="rowBill"><div class="collapsible-header"> <div class="row" id="rowBIll"> <div class="anything col s6"><span id="billingDate">' + parsed_date + '</span></div><div class="anything col s6"><span id="dailyBill">' + (0.167) + '</span></div></div></div><div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div></li></ul>'
        })
