...
function refreshBills() {
    doFetch({
        ...
        $.each(bills, function (index, obj) {
            ...
            billing_string += '<ul class="collapsible" data-collapsible="accordion"><li><span style="display:block"><div class="collapsible-header" style="background:#0F5F76;">' + parsed_date + '</div></span></ul>'
            billing_amount += '<ul class="collapsible" data-collapsible="accordion"><li><span style="display:block"><div class="collapsible-header" style="background:#0F5F76;"> ' + (0.167) + '<div class="collapsible-body"><span></span></div>' + '</div></li></ul></span>'
        })
