        ...
        if (e.status == 'ok') {
            ...
            try {
                ...
                if (feedBack.length == undefined) {
                    ...
                    var allItems = document.querySelector('.allPrds');
                    function appendPrds(n) {
                        for(x in products){
                    ...
                    var io = new IntersectionObserver(entries => {
                        // Only load new products if the senitel enters the viewport
